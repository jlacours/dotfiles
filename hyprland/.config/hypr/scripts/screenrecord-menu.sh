...
# A multi-level menu interface for wf-recorder, Hyprland only.

# Configuration
RECORDINGS_DIR="$HOME/Videos/recordings"
STATE_DIR="${XDG_RUNTIME_DIR:-/tmp}/hypr-screenrecord-$UID"
...
# prompt — which hangs when launched from the menu (no tty).
...
# Main menu flow
main() {
    local -a required_commands=(hyprctl jq notify-send pactl slurp wf-recorder)
