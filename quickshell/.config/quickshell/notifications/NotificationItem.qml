...
Rectangle {
  ...
  onHoveredChanged: {
    if (!root.compact && root.notification) {
      Notif.NotificationServer.setPopupHovered(root.notification.id, root.hovered)
    }
  }
    ...
    Column {
      ...
      Item {
        ...
        Rectangle {
          ...
          width: visible ? Math.max(22, stackLabel.implicitWidth + 10) : 0
          height: 16
          color: "transparent"
          border.width: Root.Theme.hairline
      ...
      Item {
        ...
        Rectangle {
          ...
          Rectangle {
            ...
            color: root.critical ? Root.Theme.critical : Root.Theme.accent
          }
        }
      ...
      Item {
        ...
        Rectangle {
          ...
          color: "transparent"
          border.width: Root.Theme.hairline
          border.color: replySendArea.containsMouse ? Root.Theme.accent : Root.Theme.border
